...
def split_image_to_chunks(input_image, num_chunks=20, num_records=2500, hpatch_size=1, vpatch_size=1):
    ...
    for i in range(num_chunks):
        ...
        patched_image = Image.new("RGB", (width + 2 * vpatch_width, chunk_height + 2 * hpatch_height), (255, 255, 255))
...
if __name__ == '__main__':
    ...
    image_chunks = split_image_to_chunks(image, num_chunks=1, num_records=60, hpatch_size=1, vpatch_size=1)
